...
#Regla 1: Utiliza nombres de variables descriptivos*
#Regla 2: Los nombres de variables empiezan por letras
#Regla 3: No utilices espacios para separar nombres largos

K= 52 #esto no me dice
