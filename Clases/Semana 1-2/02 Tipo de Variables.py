...
fechaDeViaje = "31 de febero del 2019" 
print("La fecha del viaje es :")
print(fechaDeViaje)
...
#Crea una variable a la que asignarás el costo del boleto, un número decimal: 925.68 dólares y muestra por pantalla el contenido de la variable.

costoBoleto= 925.68
print("El costo del boleto es", costoBoleto, "dolares")
